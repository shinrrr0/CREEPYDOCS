...
class Story(db.Model):
    ...
    # Comments attached to this story. Same cascade pattern as images
    # so deleting a story removes the comments via either ORM or SQL.
    # Ordered chronologically so iteration in templates / API matches
