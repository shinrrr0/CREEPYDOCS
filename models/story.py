...
Public attributes (id, title, body, author, created_at) match what the
templates already expect, so the data layer can be swapped without
touching the front end. Add new columns here to extend a story.
"""
...
class Story(db.Model):
    ...
    def gallery_images(self) -> List["Image"]:
        """All non-cover images, in position order."""
    ...
    # FUTURE relationships (NOT in scope for this iteration):
