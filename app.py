...
def create_app(config_class: type = Config) -> Flask:
    ...
    # so Cyrillic survives unmangled in the response body. Both forms
    # are valid JSON and decode identically client-side, but the literal
    # form is easier to debug in DevTools / curl.
